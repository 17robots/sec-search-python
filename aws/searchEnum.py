...
class SearchFilters(Enum):
    instances = "Reservations[*].Instances[*].{id:InstanceId, privdns:PrivateDnsName, pubdns:PublicDnsName, pubip:PublicIpAddress, vpcId:VpiId, privaddresses:NetworkInterfaces[*].{ipv6s:Ipv6Addresses[*], ips:PrivateIpAddresses[*].PrivateIpAddress}}"
